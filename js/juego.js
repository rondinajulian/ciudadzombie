...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_vertical.png', 180, 440, 30, 30, 1),
    //vallas costado
    new Obstaculo('imagenes/valla_vertical.png', 420, 440, 30, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 420, 475, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 470, 430, 30, 30, 1),
    //vallas arriba
    new Obstaculo('imagenes/valla_horizontal.png', 70, 110, 30, 30, 1),
    ...
    new Obstaculo('imagenes/bache.png', 480, 120, 30, 30, 1),
    new Obstaculo('imagenes/bache.png', 810, 485, 30, 30, 1),
    //veiculos verdes
    new Obstaculo('imagenes/auto_verde_abajo.png', 180, 235, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 350, 450, 30, 15, 1),
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 420, 15, 30, 1),
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',100, 480, 10, 10, 0.5,{desdeX:100,hastaX:200}),
    new ZombieCaminante('imagenes/zombie1.png',100, 480, 10, 10, 1,{desdeX:100,hastaX:200}),
    new ZombieCaminante('imagenes/zombie3.png',500, 270, 10, 10, 1,{desdeX:1,hastaX:1}),

    new ZombieCaminante('imagenes/zombie3.png',840, 270, 10, 10, 1,{desdeX:800,hastaX:900}),
    new ZombieCaminante('imagenes/zombie4.png',800, 270, 10, 10, 1,{desdeX:800,hastaX:900}),
 
    //trenes
    new ZombieConductor('imagenes/tren_vertical.png', 644, 0, 30, 90, 1,{desdeX:1,hastaX:1,desdeY:1,hastaY:580}),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 0, 30, 90, 4.9,{desdeX:1,hastaX:1,desdeY:1,hastaY:580}),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 322, 90, 30, 2,{desdeX:1,hastaX:950,desdeY:1,hastaY:1}),
  ]
...
Dibujante.dibujarImagen('imagenes/llegada.png', 760, 563, 125, 25);
